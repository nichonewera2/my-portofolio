              ...
              return (
                ...
                >
                  <div className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-cyan-glow/40 bg-void shadow-glow sm:h-10 sm:w-10">
                    <Icon size={17} className="text-cyan-glow" strokeWidth={2.25} />
                  </div>

                  <div className="glass-panel glass-panel-hover flex-1 rounded-bubble p-5 sm:p-6">
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                      <span className="font-mono text-[11px] font-semibold uppercase tracking-[0.16em] text-violet-glow/90">
                        {entry.year}
                      </span>
                    </div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-starlight/60">
                      {entry.description}
                    </p>
                  </div>
                </motion.li>
