...
export const projects: Project[] = [
  {
    ...
    title: 'SiteLens',
    description:
      'A tool that captures a live visual snapshot of any website — just paste a URL and get an instant screenshot. Built to practice working with browser automation and clean, fast UI.',
